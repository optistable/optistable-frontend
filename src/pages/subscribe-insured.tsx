        ...
        <>
            {isMounted && (
                <div className={'mt-16 flex flex-col items-center space-y-8'}>
                    <IDKitWidget
                        app_id="app_staging_28271ae31e85b74f961fd5b2333f39c8"
                        action="subscribe"
                        enableTelemetry
                        onSuccess={(verification) => {
                            console.log('joder', verification);
                        ...
                        {({ open }) => (
                            ...
                            >
                                ...
                                <div className={'flex items-center'}>
                                    ...
                                    <Select
                                        ...
                                        {...register('insurerToken', {
                                            validate: (v) =>
                                                v !==
                                                getValues('collateralToken'),
                                        })}
                                        defaultValue={
                                            Object.values(stablecoins)[0]
                                                .address
                                        }
                                    ...
                                    >
                                        {Object.values(stablecoins).map(
                                            (v, i) => StablecoinMenuItem(v, i)
                                        )}
                                    </Select>
                                </div>
                                <div className={'flex items-center'}>
                                ...
                                <p className={'text-center text-2xl'}>
                                    Policy activates in{' '}
                                    {getRandomNumber(100, 1000)} blocks
                                </p>
