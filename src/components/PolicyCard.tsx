        ...
        <Link
            href={
                activatedPolicies
                    ...
                    : `/subscribe-insured?${policy.insuredTokenAddress}&${policy.collateralTokenAddress}`
            }
            passHref
        >
            <div
            ...
            >
                <div className="flex justify-center space-x-4">
                    <div>
                        {stablecoins[
                            policy.insuredTokenAddress.toString()
                        ].icon(80, 0)}
                    </div>
                    <div
                    ...
                    <div>
                        {stablecoins[
                            policy.collateralTokenAddress.toString()
                        ].icon(80, 0)}
                    </div>
                </div>
                ...
                {activatedPolicies ? (
                    <p className="text-center text-xl">
                        {depeggedProviders || 1}/
                        {totalProviders?.toString() || 5} Depegged
                    </p>
                ) : (
